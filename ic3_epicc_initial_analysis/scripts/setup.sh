...
#
# Android SDK (Linux/MAC version): http://dl.google.com/android/android-sdk_r24.3.4-linux.tgz or http://dl.google.com/android/android-sdk_r24.3.4-macosx.zip
...
# Dare (Linux/MAC version): https://github.com/dare-android/platform_dalvik/releases/download/dare-1.1.0/dare-1.1.0-linux.tgz or https://github.com/dare-android/platform_dalvik/releases/download/dare-1.1.0/dare-1.1.0-macos.tgz
